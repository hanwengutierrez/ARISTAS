#' Datos ARISTAS matermáticas edición 2018
#'
...
#' En esta base 'ARISTAS18.matematicas' se incluye los resultados de desempeño de los estudiantes en matemáticas.
#'
#'
#' @format ## `ARISTAS18.matematicas`
#' Una base de datos con 9060 filas (estudiantes) y 402 columnas (variables)
#' \describe{
...
#'   \item{MAT1226, ..., MAT1161}{Resultados a ítems de la prueba.}
#'   \item{TotResp}{Total de respuestas sin contar omitidos ni no abordados}
#'   \item{IND_Estu_ITEM_9_MAT}{1: "El estudiante respondió al menos un ítem de la prueba de matemática", 0: "El estudiante no respondió a la prueba de matemática"}
#' }
#' @source <https://www.ineed.edu.uy/aristas-2018-tercero-de-educacion-media/>
"ARISTAS18.matematicas"
